//
//  SearchBehaviorViewController.swift
//  Autonomy
//
...
class SearchBehaviorViewController: SearchSurveyViewController {

    lazy var thisViewModel: SearchBehaviorViewModel = {
        return viewModel as! SearchBehaviorViewModel
    }()

    var filteredRecords = [Behavior]()
    ...
    override func bindViewModel() {
        ...
        thisViewModel.submitBehaviorResultSubject
            ...
            .subscribe(onNext: { [weak self] (event) in
                ...
                case .next(let behavior):
                    ...
                    self.thisViewModel.newBehaviorSubject.onNext(behavior)
...
extension SearchBehaviorViewController: UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate {
    ...
    func textFieldShouldReturn(_ textField: UITextField) -> Bool {
        ...
        thisViewModel.submitBehavior(name: text)
        return false
    }
}
