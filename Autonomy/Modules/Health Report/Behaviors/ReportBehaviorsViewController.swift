//
//  ReportBehaviorsViewController.swift
//  Autonomy
//
...
class ReportBehaviorsViewController: ViewController, BackNavigator, ReportSurveyLayout {
    ...
    var surveyTitleText = R.string.phrase.behaviorsReportTitle()
    var commonSurveyText = R.string.phrase.behaviorsReportCommon().localizedUppercase
    var recentSurveyText = R.string.phrase.behaviorsReportRecent().localizedUppercase

    lazy var thisViewModel: ReportBehaviorsViewModel = {
        return viewModel as! ReportBehaviorsViewModel
    }()
    ...
    fileprivate func showProgressPanModal() {
        ...
        viewController.titleLabel.setText(R.string.phrase.behaviorsReportSubmitting())
...
// MARK: - Navigator
extension ReportBehaviorsViewController {
    ...
    fileprivate func makeAddNewBehaviorView() -> UIView {
        let addNewView = AddRow(title: R.string.phrase.behaviorsReportAddNew())
