...
class Navigator {
    ...
    enum Scene {
        ...
        case autonomyTrending(viewModel: AutonomyTrendingViewModel)
        case dataItemTrending(viewModel: ItemTrendingViewModel)
        case reportSymptoms(viewModel: ReportSymptomsViewModel)
        ...
        case reportBehaviors(viewModel: ReportBehaviorsViewModel)
    ...
    func get(segue: Scene) -> UIViewController? {
        ...
        case .autonomyTrending(let viewModel):  return AutonomyTrendingViewController(viewModel: viewModel)
        case .dataItemTrending(let viewModel):  return ItemTrendingViewController(viewModel: viewModel)
        case .reportSymptoms(let viewModel):    return ReportSymptomsViewController(viewModel: viewModel)
        ...
        case .reportBehaviors(let viewModel):   return ReportBehaviorsViewController(viewModel: viewModel)
