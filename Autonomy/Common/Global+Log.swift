...
extension Global {
    ...
    static var log: XCGLogger = {
        ...
        let log = XCGLogger(identifier: "autonomy.logger", includeDefaultDestinations: false)
    ...
    fileprivate static let systemDestination: AppleSystemLogDestination = {
        let systemDestination = AppleSystemLogDestination(identifier: "autonomy.logger.syslog")
    ...
    fileprivate static let fileDestination: AutoRotatingFileDestination = {
        ...
        let fileDestination = AutoRotatingFileDestination(writeToFile: logFileURL, identifier: "autonomy.logger.file", shouldAppend: true)
    ...
    fileprivate static let sentryDestination: SentryDestination? = {
        do {
            let sentryClient = try Client(dsn: Constant.sentryDSN)
