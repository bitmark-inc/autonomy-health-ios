...
class AppVersion {
    ...
    static func showAppRequireUpdateAlert(updateURL: URL) {
        let alertController = UIAlertController(
            title: R.string.error.requireAppUpdateTitle(),
            message: R.string.error.requireAppUpdateMessage(),
            preferredStyle: .alert)

        let action = UIAlertAction(title: R.string.error.requireAppUpdateAction(), style: .default) { (_) in
